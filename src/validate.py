...
def main():     
     ...
     while True:         
          ...
          if candidates:             
               ...
               if valid_plate:                 
                    cv2.putText(vis, f"VALID: {valid_plate}", (x, y), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 0), 2)

               else:                 
                    if raw_text:                     
                         cv2.putText(vis, f"OCR: {raw_text}", (x, y), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 165, 255), 2)         
