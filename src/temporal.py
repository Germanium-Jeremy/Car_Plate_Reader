     ...
     while True:         
          ...
          if candidates:             
               ...
               if valid_plate:                 
                    ...
                    cv2.putText(vis, f"CONFIRMED: {confirmed_plate}", (x,y), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0,255,0), 2)                 
                    
                    now = time.time()                 
                    if (confirmed_plate and confirmed_plate != last_saved_plate and (now - last_saved_time) > COOLDOWN):                     
